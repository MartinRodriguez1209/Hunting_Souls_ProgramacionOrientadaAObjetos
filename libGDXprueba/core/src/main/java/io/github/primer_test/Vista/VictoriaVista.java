...
public class VictoriaVista {

    private Stage stage;
    private MenuControlador controlador;
    private Texture fondoTextura;
    
    private Skin skinTitulos;
    private Skin skinBotones;
    
    private BitmapFont fuenteTitulo;

    public VictoriaVista(MenuControlador controlador) {
    ...
    public void show() {
        ...
        fondoTextura = new Texture(Gdx.files.internal("victoria.png"));
        Image fondo = new Image(fondoTextura);
        fondo.setSize(Gdx.graphics.getWidth(), Gdx.graphics.getHeight());
        stage.addActor(fondo);

        skinTitulos = new Skin(Gdx.files.internal("skins/uiskin.json"));
        skinBotones = new Skin(Gdx.files.internal("ui/uiskin.json"));
        ...
        estiloTitulo.fontColor = Color.GOLD;

        Label titulo = new Label("¡VICTORIA!", estiloTitulo);

        Label subtitulo = new Label("Has vencido a las almas olvidadas", estiloTitulo);
        ...
        TextButton botonSalir = new TextButton("CONTINUAR", skinBotones);
        TextButton botonVolverMenu = new TextButton("VOLVER AL MENU", skinBotones);
    ...
    public void dispose() {
        ...
        if (skinTitulos != null) skinTitulos.dispose();
        if (skinBotones != null) skinBotones.dispose();
